...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Isotop2.Data.Entities.RAO", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Isotop2.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            Administrator = true,
                            HashPassword = "auPAL1Sso5X9X7sdacYQTgDN8z4gpd3hGLCpp/Et/G6J/2LDxKz9O7RKK8FQ9BcfMQ==",
                            UserName = "Admin"
                        },
                        new
                        {
                            UserId = 2,
                            Administrator = false,
                            HashPassword = "H0yEASs4ezLMMi3DIgBd0QCdIV5qTL+q8uyGa3MGvdVvse3aurncEvNh/yd4sVxM+g==",
                            UserName = "User"
                        });
                });
            ...
            modelBuilder.Entity("Isotop2.Data.Entities.Organ", b =>
                {
                    b.Navigation("RadiationExposure");
                });
